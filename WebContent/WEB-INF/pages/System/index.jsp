...
<head>
  ...
  <script src="${contextPath}/resources/js/echarts.min.js"></script>
</head>
<style>
                        ...
                        <div class="tpl-scrollable">
                            ...
                            <table class="am-table tpl-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img src="${contextPath}/resources/img/user01.png" alt="" class="user-pic">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="${contextPath}/resources/img/user02.png" alt="" class="user-pic">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="${contextPath}/resources/img/user03.png" alt="" class="user-pic">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="${contextPath}/resources/img/user04.png" alt="" class="user-pic">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="${contextPath}/resources/img/user05.png" alt="" class="user-pic">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="${contextPath}/resources/img/user06.png" alt="" class="user-pic">
...
<script src="${contextPath}/resources/js/iscroll.js"></script>
